...
const ProductTabs = ({ product }) => {
      ...
      case "additional":
        return (
          <div className="py-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {product.product_props.map((prop) => (
                <div key={prop.id} className="bg-gray-50 p-4">
                  <h3 className="font-semibold">{prop.label}</h3>
                  <p>{prop.master_value}</p>
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <div className="max-w-7xl mx-auto mt-8 p-6  w-full">
      <div className="border-b border-gray-200">
        <nav
